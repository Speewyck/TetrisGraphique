...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mSquare   = new Square(mSquarePosition, -100,-100,0,0);
        //mSquare2   = new Square(mSquarePosition, -200,-100,100,-100);
        mSquare2=new Square(mSquarePosition, -200,-100,-100,-0);
        mSquare3   = new Square(mSquarePosition, -300,-100,-200,0);
    }
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Matrix.orthoM(mProjectionMatrix, 0, -(width/2) , (width/2), -height/2, height/2, -1.0f, 1.0f);
